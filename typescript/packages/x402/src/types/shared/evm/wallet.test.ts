...
import { base, bsc, avalancheFuji } from "viem/chains";
...
describe("createConnectedClient", () => {
  ...
  it("should create a public client for bsc-mainnet network", () => {
...
describe("createSigner", () => {
  ...
  it("should create a wallet client for bsc-mainnet network with private key", () => {
    const signer = createSigner("bsc-mainnet", mockPrivateKey);
