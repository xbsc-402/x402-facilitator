...
import { authorizationTypes, isAccount, isSignerWallet, } from "../../../types/shared/evm";
/**
 ...
 */
export async function signAuthorization(walletClient, { from, to, value, validAfter, validBefore, nonce }, { asset, network, extra }) {
