 ...
 */
export function getUsdcAddress(client) {
 ...
 */
export function getUsdcAddressForChain(chainId) {
 ...
 */
export function getUsdcChainConfigForChain(chainId) {
 ...
 */
export async function getUSDCBalance(client, address) {
