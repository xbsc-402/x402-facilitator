import { createKeyPairSignerFromBytes, createKeyPairSignerFromPrivateKeyBytes, isKeyPairSigner, } from "@solana/kit";
 ...
 */
export function createSvmConnectedClient(network) {
 ...
 */
export async function createSignerFromBase58(privateKey) {
