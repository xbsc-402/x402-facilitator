...
describe("getDefaultAsset", () => {
  ...
  it("should return Base Sepolia USDC asset details", () => {
    const result = getDefaultAsset("bsc-mainnet");
...
describe("processPriceToAtomicAmount", () => {
  it("should handle string price in dollars", () => {
    const result = processPriceToAtomicAmount("$0.01", "bsc-mainnet");
    expect(result).toEqual({
  ...
  it("should handle token amount object", () => {
    ...
    const result = processPriceToAtomicAmount(tokenAmount, "bsc-mainnet");
    expect(result).toEqual({
  ...
  it("should handle invalid price format", () => {
    const result = processPriceToAtomicAmount("invalid", "bsc-mainnet");
    expect(result).toEqual({
  ...
  it("should handle zero price", () => {
    const result = processPriceToAtomicAmount("$0", "bsc-mainnet");
    expect(result).toEqual({
